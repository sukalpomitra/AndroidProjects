...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Integer> sRawTextFeedIds = args.getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
		
		// TODO: Start the DownloaderTask
        task.execute(sRawTextFeedIds);
    ...
    public class DownloaderTask extends AsyncTask<ArrayList<Integer>, Integer, String[]>
    {
            ...
            mContext.sendOrderedBroadcast(new Intent(
                    ...
                    new BroadcastReceiver() {
                        ...
                        public void onReceive(Context context, Intent intent) {
                            ...
                            if (getResultData() == null || !getResultData().equals(String.valueOf(MainActivity.IS_ALIVE))) {
        ...
        @Override
        protected String[] doInBackground(ArrayList<Integer>... sRawTextFeedIds) {
            ArrayList<Integer> feedIds = sRawTextFeedIds[0];
            Integer[] resIDs = new Integer[feedIds.size()];
            for (int i = 0; i <= feedIds.size() - 1; i++)
            {
                resIDs[i] = feedIds.get(i);
            }
            String[] feeds = downloadTweets(resIDs);
            return feeds;
        }
